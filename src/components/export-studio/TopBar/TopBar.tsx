        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            className={`h-8 gap-1.5 transition-all ${
              bulkEditMode 
                ? "bg-indigo-600 hover:bg-indigo-700 text-white border-indigo-600 shadow-md ring-2 ring-indigo-200" 
          ...
          >
            <div className="flex items-center gap-1.5">
              ...
              {bulkEditMode && <Badge className="h-4 px-1 text-[8px] bg-white text-indigo-700 hover:bg-white ml-1">ACTIVE</Badge>}
            </div>
          </Button>
