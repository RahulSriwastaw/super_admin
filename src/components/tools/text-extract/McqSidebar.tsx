              ...
              {mcqs.length > 0 && (
                <div className="flex flex-col gap-2 pt-2 border-t border-slate-100">
                  ...
                  <button 
                    ...
                    className="w-full flex items-center justify-center gap-2 py-2 bg-emerald-50 text-emerald-700 hover:bg-emerald-100 rounded-lg text-sm font-semibold transition-colors mt-1"
                  >
                    <BookOpen className="w-4 h-4" />
                    Save all to Drafts (Bank)
                  </button>
